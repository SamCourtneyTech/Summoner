...
void SynthesizerComponent::paint(juce::Graphics& g)
{
    ...
    // Paint oscillator 1 background using OscillatorBackgroundPainter
    OscillatorBackgroundPainter::paintOscillator1Background(
        g,
        getLocalBounds(),
        oscillatorBackgroundOffsetX,
        oscillatorBackgroundOffsetY,
        adsrKnobsGroupOffsetX,
        adsrKnobsGroupOffsetY,
        volumeControlsGroupOffsetX,
        volumeControlsGroupOffsetY,
        pitchControlsGroupOffsetX,
        pitchControlsGroupOffsetY
    );

    // Second oscillator section background
